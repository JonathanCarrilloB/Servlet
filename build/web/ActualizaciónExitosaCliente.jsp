...
<head>
    ...
    <meta http-equiv="refresh" content="4; url=UsuarioServlet"> <!-- Redirige al inicio después de 3 segundos -->
...
<body class="container text-center py-5">
    <div class="alert alert-success" role="alert">
        ...
        <p>La información del usuario se ha actualizado correctamente.</p>
        <hr>
        <p class="mb-0">Serás redirigido al inventario en breve...</p>
    </div>
    <!-- Botón de redirección manual -->
    <a href="UsuarioServlet" class="btn btn-primary">Ir al inicio</a>
